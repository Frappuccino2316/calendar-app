...
from api.views import TaskViewSet, TeamViewSet, UserViewSet, ManageUserView, TeamAndTasks, TeamAndMembers, ApplicantsViewSet
...
urlpatterns = [
    ...
    # path('applicants/', Applicants.as_view(), name='applicants'),
